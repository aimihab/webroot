    ...
    <div id="AandEwin" class="easyui-window" collapsible="false" minimizable="false" maximizable="false" closed="true" style="width:400px;height:350px;padding-left:30px">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
			...
			<tr height="30px">
		        ...
		        <td align="left"> 
		        	<input id="MENU_ID" name="MENU_ID" type="hidden"></input>
		        	<input id="MENU_NAME" name="MENU_NAME" style="width:160px;">  </td>
		               <td width="10"></td>
		    </tr>
		  	<tr height="30px">
		        <td><div align="right">
		        ...
		        <td align="left"> <input id="MENU_ICON" name="MENU_ICON"  style="width:160px;">  </td>
		       <td width="10"></td>
		    </tr>
		    <tr height="30px">
		        <td><div align="right">
		        ...
		        <td align="left"> <input id="MENU_URL"  name="MENU_URL" style="width:160px;">  </td>
		       <td width="10"></td>
		    </tr>
		    <tr height="30px">
		        <td><div align="right">
		        ...
		        <td align="left">
		        	<input name="PARENT_MENU_ID" id="PARENT_MENU_ID" style="width:160px;">
		        </td>
		       <td width="10"></td>
		    </tr>
		    <tr height="30px">
