    ...
    <div id="AandEwin" class="easyui-window" collapsible="false" minimizable="false" maximizable="false" closed="true" style="width:400px;height:350px;padding-left:30px">
		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
			...
			<tr height="30px">
		        ...
		        <td align="left"> 
		        	<input id="DEP_ID" name="DEP_ID" type="hidden"></input>
		        	<input id="DEP_NAME" name="DEP_NAME" style="width:160px;">  </td>
		               <td width="10"></td>
		    </tr>
		    <tr height="30px">
		        <td><div align="right">
		        ...
		        <td align="left">
		        	<input name="PARENT_DEP_ID" id="PARENT_DEP_ID" style="width:160px;">
		        </td>
		       <td width="10"></td>
		    </tr>
		    <tr height="30px">
