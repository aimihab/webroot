...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        function serverLogin() {
            ...
            $.ajax({
                 type: "POST",
                 url: "webapi/login_api.php?action=modifyPass",
                 data: {
                    newpass : $newpass.val(),
            ...
            $('#loginOut').click(function() {
                $.messager.confirm('系统提示', '您确定要退出本次登录吗?', function(r) {
                    ...
                    if (r) {
                        $.ajax({
                             type: "POST",
                             url: "webapi/login_api.php?action=loginout",
                             dataType: "text",
                             success: function(data){
                                 location.reload();
                             }
...
<div style=" position:absolute; z-index:100000; height:90%;top:0px;left:0px; width:90%; background:white; text-align:center;">
    ...
    <div data-options="region:'north'" split="true" border="false" style="overflow: hidden; height: 60px;
        background: url(images/3-top_bg.png);
    ...
    <div id="mainPanle" data-options="region:'center'" style="background: #eee; overflow-y:hidden">
        <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
            <div title="欢迎使用" style="overflow:hidden;background:url(images/1-welcome.jpg) repeat-x center 50% ;" id="home" >
            </div>
        </div>
    </div>
    <!--修改密码窗口-->
